...
YOLO_MODEL_PATH = os.path.join(BASE_DIR, os.getenv('YOLO_MODEL_PATH', 'train4/weights/best.pt'))
...
SELECTED_COLOR_GROUP_BBOX_COLOR = Color(255, 255, 0)
ROUTE_LINE_COLOR = Color.blue()
ROUTE_LINE_WIDTH = 6
